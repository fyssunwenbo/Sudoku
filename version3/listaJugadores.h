...
typedef struct {
	tJugadorPtr *jugadores; // array din芍mico de punteros
	//tArrayJugadores jugadores;
	int cont; // contador
	int capacidad; // capacidad del array din芍mico
} tListaJugadores;

void ampliar(tListaJugadores &lista); /* ampl赤a la dimensi車n del
array din芍mico de lista al doble de la que tiene.Los datos de los
jugadores que ya existen en la lista deben mantenerse.*/

void borrarListaJugadores(tListaJugadores &lista); /* libera la
memoria din芍mica usada por lista.*/

void borrarJugadores(tListaJugadores &lista); /* libera la memoria
din芍mica usada por los punteros almacenados en lista.*/

void liberarArray(tListaJugadores &lista); /* libera la memoria
din芍mica utilizada por el array din芍mico de lista.
*/
